...
Led platform migration from HaptX to Senseglove SDK for nuclear glovebox training and simulation, directing art asset implementation and MR integration on VARJO headset for deployment at DOE ORETTC facilities—delivering enhanced haptic training capabilities for critical nuclear operations.
...
<!-- - **[NEEDS INFO: Art direction work]** Led art asset optimization for MR rendering on VARJO—need specifics: polygon count reductions, texture optimization percentages, or visual quality improvements achieved. -->
...
- Developed and implemented multiplayer supporting 4 concurrent users and real-time physics with `<100ms` latency across 2 simultanious HaptX glove devices, Vive Focus 3, and Meta Quest—enabling collaborative training in high consequence virtual environments.
...
- Created selectable room information data pipline including dynamic room and instructor scheduling, room function data, and carousel image support.
